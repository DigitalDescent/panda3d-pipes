...
// These classes are compiled locally in this module, not imported from Panda3D's
// mathutil library, so override the dllimport macros to be empty.
#ifdef EXPCL_PANDA_MATHUTIL
  #undef EXPCL_PANDA_MATHUTIL
#endif
#define EXPCL_PANDA_MATHUTIL
#ifdef EXPTP_PANDA_MATHUTIL
  #undef EXPTP_PANDA_MATHUTIL
#endif
#define EXPTP_PANDA_MATHUTIL
